...
class HomeView(View):
    ...
    def get(self, request):
        return render(request, self.template_name, {'POSTS': Post.get_posts_formatted(), 'CATEGORIES': Post.get_categories_formatted_sidebar(), 'ARCHIVE': Post.get_archive_posts_sidebar()})
