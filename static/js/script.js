...
$(document).ready(function() {
    ...
    // Call scramble for all of the class tags even if they're not in use (so we can use them later if we want to)
    $('.scramble-all').scramble(3000, 20, "all", true);
    $('.scramble-alpha').scramble(3000, 20, "alphabet", true);
    $('.scramble-num').scramble(3000, 20, "numbers", true);
    $('.scramble-punct').scramble(3000, 20, "punctuation", true);
});

/** https://github.com/cjbarnaby/text_descrambler */
(function( $ ) {
